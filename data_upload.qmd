...
chart <- ggplot(data = data, aes(x = converted_x, y = converted_y)) + geom_tile(aes(fill = shot_distance)) + coord_fixed()+ theme(panel.grid.major = element_blank(), panel.grid.minor = element_blank(), panel.background = element_rect(fill = "white"), axis.title = element_blank(), axis.text = element_blank(), axis.ticks = element_blank()) 
...
team_totals <- team_totals |>
  ...
  filter(SEASON == "2012" | SEASON == "2013")
```
